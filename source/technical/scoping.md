...
Second, named functions cannot directly access surrounding scope, one has to
...
* any variable introduced in a clause pattern/condition will be accessible only
